"""
Django settings for app-example project.
...
WSGI_APPLICATION = 'app-example.wsgi.application'
...
# Email Config
EMAIL_SUBJECT_PREFIX = '[app-example]'
DEFAULT_FROM_EMAIL = 'No Reply <no-reply@app-example.com>'
SERVER_EMAIL = 'Server <server@app-example.com>'
# ADMINS = [('Admin', 'admin@app-example.com')]
# MANAGERS = [('Admin', 'admin@app-example.com')]
